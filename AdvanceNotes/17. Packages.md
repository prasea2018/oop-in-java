# 📘 **Java Packages — Clean Notes & Explanation**
...
## **5.1 Method 1 → Import entire package using `*`**
...
## **5.2 Method 2 → Import only a specific class**
...
## **5.3 Method 3 → Do NOT import; use fully-qualified name**
...
### ✔ Classes & interfaces become `.class` files

After compilation.

### ✔ Java's built-in packages are stored inside `src.zip`

### ✔ Three ways to access a class from a package:
...
# 📦 **Java Packages – Creating & Using Custom Packages (Simplified Notes)**
...
# 📌 **1. What is a Package (Quick Recap)?**
...
## 📝 **Step 1 – Write a class and specify a package**
...
⚠️ The `package` statement **must be the first line** of the file.
...
## 📝 **Step 3 – Compile WITH package creation**
...
✔️ A folder **mypack1** is automatically created
✔️ `Demo.class` is inside that folder

---

# 📌 **3. Adding More Classes to the Same Package**
...
✔️ You created a sub-package: `mypack1.inner`

---

# 📌 **5. Using Your Custom Packages**
...
✔️ You successfully imported and used your own packages!
...
### ✔ `javac -d <path>` creates folders for packages
...
### ✔ If not importing, you must use full path:
...
* `LoanCalculator.java` class → prints “Loan Calculated”
* `EMICalc.java` class → prints “EMI Calculated”
...
## 1️⃣ **Where access modifiers can be applied**
...
## 2️⃣ **Ways to use a class**

* **By creating an object** → *has-a* relationship
* **By inheritance (extends)** → *is-a* relationship

**Examples:**

```java
Demo1 d = new Demo1(); // has-a
class Demo2 extends Demo1 {} // is-a
```
...
| `default`   | ❌ Not accessible | ❌ Not accessible |
...
## 1️⃣ **Why Naming Conventions Matter**
...
## 2️⃣ **Recommended Convention**

* Use your **organization’s Internet domain name in reverse** as the **base package**.
